...
import { Coupon, CuoponResponseSchema, Product, ShoppingCart } from './schemas';
...
export const useStore = create<Store>()(devtools((set, get) => ({
    ...
    addToCart: (product) => {
        ...
        //devuelve la posicion del arreglo si existe >= 0 en caso contrario devuelve -1
        if (duplicated >= 0) {
    ...
    applyCoupon: async (couponName) => {
        ...
        const coupon = CuoponResponseSchema.parse(json)
